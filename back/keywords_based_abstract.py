...
class KeywordsBasedAbstract:
    ...
    # самые частые 20 слов в документе
    ...
    # возвращает словарь {слово: [словосочетания]}
    # чаще всего список словосочетаний пуст((( особенно в доках с литературой
    ...
    # возвращает строку с отступами (иерархическую)
...
# TODO: добавить числительные в stopwords!!


if __name__ == "__main__":
    abstract_creator = KeywordsBasedAbstract()
    file = "rus_literature.html"
    document = Document(file, utils.get_file_contents(os.path.join("D:\\УЧЁБА\\4 курс\\7 сем\\еязиис\\abstract_writer\\docs\\rus", file)))
    s = abstract_creator.get_hierarchy_abstract(document)
    print(s)
